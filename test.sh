...
#SBATCH --exclude=plai05,plai06,plai07
...
TRAIN_SEQ_LEN=64 # 32 / 64
# TRAIN_SEQ_LEN=256 # 256 
RNN_PATH="${RNN_CKPT_DIR}/seq${TRAIN_SEQ_LEN}-ind_head-mnist-mingru-ly4-b64-lr0.0001-1000k/ckpt_500000.pt"
# RNN_PATH="${RNN_CKPT_DIR}/seq${TRAIN_SEQ_LEN}-sel_copy-mnist-mingru-ly4-b64-lr0.0001-1000k/ckpt_200000.pt"
RNN_TYPE="mingru"
NUM_LAYERS=4 # 2 / 4
NUM_HEADS=4
...
singularity exec --nv \
    ...
    ${SIF_PATH} torchrun --nproc_per_node ${NUM_GPUS} --rdzv_endpoint=localhost:$PORT test.py \
